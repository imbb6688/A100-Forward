...
if manifest.get('latest_trade_date')!=latest_date: raise SystemExit('FAIL CLOSED: account date differs from HiThink manifest')
if int(manifest.get('latest_rows',0))<4500: raise SystemExit('FAIL CLOSED: incomplete full-market session')
